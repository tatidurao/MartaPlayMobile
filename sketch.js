...
function setup() {
 ...
 if(isMobile){
  ...
  //500,600
 //415,550,50,50
 buttonComecar=createSprite(canW-85,canH-50,50,50)
 buttonComecar.visible = false
 //142,350
 buttonSom1=createSprite(canW-360,canH-250)
 ...
 //75,480
 buttonSom2=createSprite(canW-415,canH-120)
 ...
 //330,540
 buttonSom3=createSprite(canW-170,canH-60)
 ...
 //440,380
 buttonSom4=createSprite(canW-60,canH-220)
 ...
 //380,320
 buttonSom5=createSprite(canW-120,canH-280)
 ...
 //moviemnto 99,295
 pc = createSprite(canW/5,canH/2,20,30);
 ...
 tente_novamente = createImg('./cenas/tente_novemente.png') //265,200
 tente_novamente.position(canW-235,canH-400);
 tente_novamente.size(180,20);  

 text1 = createElement("h1");
 text1.html("MEETVIB");
 text1.position(canW-430, canH-490)///70,110
 ...
 textDica1.position(canW-430, canH-470)//70,130
 textDica1.class("greeting2");

 access1 = createInput("")
 access1.position(canW-430, canH-400);//70,2000
 access1.style('background', 'white');  
 access1.class("input")

 button1 = createImg('./sinalizadores/check.png')
 button1.position(canW-360, canH-360);//140,240
 button1.size(40,40);

 text2 = createElement("div");
 text2.html("EMASIRI");
 text2.position(canW-430, canH-490)//70,110
 ...
 textDica4.position(canW-430, canH-470)
 textDica4.class("greeting2");

 access4  = createInput("")
 access4.position(canW-430, canH-400);
 access4.style('background', 'white');  

 button4 = createImg('./sinalizadores/check.png')
 button4.position(canW-360, canH-360);
 button4.size(50,50);

 text5 = createElement("h2");
 text5.html("PAUIPAC");
 text5.position(canW-430, canH-490)
 ...
 textDica5.position(canW-430, canH-470)
 textDica5.class("greeting2");

 access5  = createInput("")
 access5.position(canW-430, canH-400);
 access5.style('background', 'white');  

 button5 = createImg('./sinalizadores/check.png')
 button5.position(canW-360, canH-360);
 button5.size(50,50);
 esconderelementos()
...
{  
  ...
  if(cena === 2){
    ...
    textSize(15);
    fill("white");
    text("PONTUAÇÃO: " + score, canW-150, canH-550);//350,50
  ...
  //escuta 2 Siriema
    ...
    //pressionar apenas se o var habilitar 1 for true
    if(mousePressedOver(buttonSom2) || touches.length > 0 && habilitar2){
  ...
  //pressionar apenas se o var habilitar 1 for true
  if(mousePressedOver(buttonSom3) && habilitar3 || touches.length > 0){
...
//escuta 4 jacupemba
  ...
  //pressionar apenas se o var habilitar 1 for true
  if(mousePressedOver(buttonSom4)|| touches.length > 0 && habilitar4){
...
//pressionar apenas se o var habilitar 1 for true
if(mousePressedOver(buttonSom5)|| touches.length > 0 && habilitar5){
...
function acaobutton5()
{
  if(authenticate(accessCode5[1],access5.value())||authenticate(accessCode5[2],access5.value())||authenticate(accessCode5[3],access5.value())){
    ...
    buttonSom5.x = canW-110 //390
    buttonSom5.y = canH-390 //210
    pc.x = canW-230//270
    pc.y = canH-270//330
